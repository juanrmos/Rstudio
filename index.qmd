...
modelo_rf <- randomForest(
  factor(Es_Sospechoso) ~ Monto_Normalizado + Mes + Es_Fin_Año + 
    Dias_Desde_Inicio + Participacion_Mercado,
  data = datos_modelo,
  ntree = 500,
  importance = TRUE
)
...
benford_test <- benford(datos$Monto_limpio, number.of.digits = 1)
plot(benford_test)

cat("\nTest de Benford - Desviación significativa indica manipulación de cifras\n")
print(benford_test)
```
